...
UPSTREAM_REPO="https://github.com/MiSTer-devel/CoCo3_MiSTer.git"
CORE_NAME=(CoCo3)
...
UPSTREAM_CORE_NAME=(CoCo3)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(CoCo3.qpf)
COMPILATION_OUTPUT=(output_files/CoCo3.rbf)
